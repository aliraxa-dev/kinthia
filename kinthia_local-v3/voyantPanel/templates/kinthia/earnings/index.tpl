        ...
        <table class="table text-nowrap">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{$earning.phonetimeCurrentmonth}</td>
              <td>{math equation="($earning.totalEarningchatCurrentmonth/60)*1" format="%.2f"}€</td>
            </tr>
            <tr>
        ...
        <table class="table text-nowrap">
          ...
          <tbody>
            ...
            <tr>
              <td>Temps passé au chat</td>
              <td>{$statistic.phone_usedtime}</td>
              <td>{math equation="($earning.totalEarningChat/60)*1" format="%.2f"}€</td>
            </tr>
            <tr>
              <td>Temps passé par webcam</td>
            ...
            <tr class="bg-kinthia">
              <td><strong>Gain total</strong></td>
              <td></td>
              <td><strong>{math equation="($statistic.answeredQuestionsEarning) + ($earning.totalEarningPhone/60)*1 +($earning.totalEarningWebcam/60)*1 + ($earning.totalEarningChat/60)*1" format="%.2f"}€</strong></td>
            </tr>
          </tbody>
        </table>
      </div>
