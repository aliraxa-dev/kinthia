...
var displayChat = "{$voyant.displayChat}";
...
{*							 depuis <span class="status-display-time">00</span>:<span class="status-display-time">02</span>:<span class="status-display-time">45</span>*}
			...
			<li>
				...
				{if $voyant.displayChat && $voyant.consultationStatus=="ON"}
					{assign var="pUrl" value="/consultation/start/".$voyant.voyantId."/chat"}
					<a id="startConsultation-chat" href="{$pUrl|url}" class="status-wrapper chat-details present typ" title="Chat"></a>

				<!-- logged / webcam ON / chat off / expert is not in consultation -->
				{elseif $voyant.displayWebcam && $voyant.consultationStatus=="ON"}
					<div class="status-wrapper chat-details offline"></div>

				<!-- logged / chat on / waiting for consultation response -->
				{elseif $voyant.displayChat && $voyant.consultationStatus=="P"}
					<div class="status-wrapper chat-details busy">
						<div class="status-display">
							<span class="status-display-text">En consultation</span><br>
							{* depuis <span class="status-display-time">00</span>:<span class="status-display-time">02</span>:<span class="status-display-time">45</span> *}
						</div>
				...
				<!-- user loggedIn && Webcam on && chat off && waiting for consultation response -->
				{elseif $voyant.displayWebcam && $voyant.consultationStatus=="P"}
					<div class="status-wrapper chat-details offline"></div>
				...
				<!-- logged / webcam ON / chat off / In consultation -->
				{elseif $voyant.displayWebcam && $voyant.consultationStatus=="B"}
					<div class="status-wrapper chat-details offline">
						<div class="status-display">
							<span class="status-display-text">indisponible</span><br>
							depuis <span class="status-display-time clock_{$voyant.voyantId}">
										<input type="hidden" class="cHour" value="{$voyant.consultationTime|date_format:'%H'}">
