        ...
        <div class="row">
          <div class="col border-right">
            <div class="description-block">
              <h5 class="description-header">Count : phone / webcam / Chat / question </h5>
              <span class="description-text">{$voyant.phone_usedcount} | {$voyant.vdo_usedcount} | {$voyant.chat_usedcount} | {$voyant.userQuestionscount}</span>
            </div>
            <!-- /.description-block -->
          </div>
          <!-- /.col -->
          <div class="col border-right">
            <div class="description-block">
              <h5 class="description-header">Time : phoneCount / webcamCount/ Chat</h5>
              <span class="description-text">{$voyant.phone_usedtime} | {$voyant.vdo_usedtime} | {$voyant.chat_usedtime}</span>
            </div>
            <!-- /.description-block -->
            </div>
          <!-- /.col -->
          <div class="col border-right">
            <div class="description-block">
              <h5 class="description-header">Gain : phone / webcam / Chat / question</h5>
              <span class="description-text"> {math equation="($statistic.totalEarningPhone/60)*1" format="%.2f"}€ | {math equation="($statistic.totalEarningWebcam/60)*1" format="%.2f"}€ | {math equation="($statistic.totalEarningChat/60)*1" format="%.2f"}€ | {$statistic.answeredQuestionsEarning}€</span>
            </div>
            <!-- /.description-block -->
          </div>
          <!-- /.col -->
...
<div class="card">
  <div class="card-header">
    <h3 class="card-title">Consultation by chat</h3>
    {include file="includes/tableNavigation.tpl"}
  </div>
  <!-- /.card-header -->
  <div class="card-body table-responsive p-0 custom-card-body">
...
<tbody>
 ...
 {foreach from=$userconsultationsbychat item=userConsultationChat}
<tr class="{cycle values='bg-grey-kin, '}">
  <td> {$userConsultationChat.created_at|date_format:"%D"}</td>
    <td>{$userConsultationChat.duration}</td>
    <td>{$userConsultationChat.user.name}</td>
    <td><a href="#" title="Show invoice" class="">See</a></td>
