...
<img src="{'/templates/adrooo/images/leftNavigationArrow.gif'|resurl}" class="pagination" alt="{if !empty($pageNavigation.title)}{$pageNavigation.title} - {'page'|lang} {$previousPage}{else}left arrow{/if}" />
</a>
{/if}  
...
<img src="{'/templates/adrooo/images/rightNavigationArrow.gif'|resurl}" class="pagination" alt="{if !empty($pageNavigation.title)}{$pageNavigation.title} - {'page'|lang} {$nextPage}{else}right arrow{/if}"/>
</a>
{/if}   
