...
class Admin_AdController extends AppController
{
     ...
     */
    public function getAdsOnPageAction()
    {
     ...
     */
    public function deleteCriteriaAction($adCriterionId)
    {
     ...
     */
    public function editCriteriaAction($adCriterionId)
    {
     ...
     */
    public function saveAdCriteriaEditAction($adCriterionId)
    {
     ...
     * Save new criterion
     */
    public function saveNewCriteriaAction()
    {
