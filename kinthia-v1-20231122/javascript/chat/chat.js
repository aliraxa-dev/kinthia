...
const socket = io('https://kinthia.com:5000?find='+user.id+'&requestId='+user.requestId+'&type='+user.type+'&name='+user.name,{secure: true,'sync disconnect on unload':true});
...
function showImage(image) {
   let content = '';
   let imagefile= '/projects/voyance/uploads/chat/'+image.text;
   if(image.type=='V') {
