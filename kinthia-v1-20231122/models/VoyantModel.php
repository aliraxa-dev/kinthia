...
{   
    ...
    public function getFields()
    {
        return array('voyantId','name', 'imageSrc','displayNameOnInvoice', 'firstName', 'displayFirstNameOnInvoice',
                     ...
                     'contactDescription', 'supportDescription', 'payPalEmail', 'priority',
                     ...
                     'shortDescription', 'tva', 'displayTvaOnInvoice', 'available','gender','paymentExpertPlatform','bankIban','country','companyName','companyFormat','phoneNumber','mobileNumber','bankBic','paidBackQuestion','paidBackPhone','paidBackWebcam','urlName','displayPhone','displayWebcam','displayEmail');
    }
