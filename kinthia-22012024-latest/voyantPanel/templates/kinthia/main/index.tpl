    ...
    <div class="card card-widget widget-user">
      ...
      <div class="card-footer">
        <div class="row">
          ...
          <div class="col border-right">
            <div class="description-block">
              <h5 class="description-header">{$voyant.chat_usedtime}</h5>
...
{if $consultationIds && in_array(2, $consultationIds)}
  ...
  {if $consultationIds && in_array(4, $consultationIds)}
  <div class="col-md-3">
    <div class="card">
      <div class="card-header">
        ...
        <div class="card-tools">
          {* <input type="checkbox" name="my-checkbox" checked data-bootstrap-switch data-off-color="danger" data-on-color="success"> *}
          {* <input type="checkbox" name="displayChat" value="1" checked data-bootstrap-switch data-off-color="danger" data-on-color="success"> *}

           <form action="{'/voyantPanel/main/saveConsultation'|url}" method="post" id="frmChat">
           <label class="switch">
             <input type="checkbox" id="displayChat" name="displayChat" {if $voyant.displayChat}value="1"{else}value="0"{/if} {if $voyant.displayChat} checked {else} {/if} {if $voyant.available}{else}disabled{/if} data-toggle="toggle" class="switchBtn>
             <span class="slider round"></span>
            </label>
          </form>
        </div>
      ...
      <!-- /.card-header -->
      <div class="card-body-kin">
        <span class="info-box-icon-kin bg-info"><i class="far fa-comments"></i></span>
        <div class="info-box-content-kin">
          <span class="info-box-text">Consultation par chat actif.</span>
          <span class="info-box-text">Vous pouvez avoir des consultations par chat.</span>
        </div>
      </div>
      <!-- /.card-body -->
    </div>
...
<div class="row">
      ...
      <div class="card-body table-responsive p-0">
        <table class="table text-nowrap">
          ...
          <tbody>
            ...
            <tr>
              <td>Temps passé au chat</td>
              <td>{$voyant.chat_usedtime}</td>
              <td>{math equation="($statistic.totalEarningChat/60)*1" format="%.2f"}€</td>
            </tr>
            <tr>
  ...
  <div class="col-md-6">
    ...
    <div class="card">
      ...
      <div class="card-body">
        <canvas id="donutChart" data-id3={math equation="($statistic.totalEarningChat/60)*1" format="%.2f"}  data-id2={$statistic.answeredQuestionsEarning} data-id1={math equation="($statistic.totalEarningPhone/60)*1" format="%.2f"} data-id={math equation="($statistic.totalEarningWebcam/60)*1" format="%.2f"} style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%;"></canvas>
      </div>
      <!-- /.card-body -->
    </div>
    <!-- /.card -->
