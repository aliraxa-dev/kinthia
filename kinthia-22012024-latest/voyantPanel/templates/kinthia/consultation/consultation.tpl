...
{capture assign="footerData"}
  ...
  <script type="text/javascript" src="{'/voyantPanel/javascript/consultation/consultation.js'|resurl}"></script>
{/capture}
      ...
      <div class="card-body">
        <div class="form-group">
          ...
          <div class="input-group">
            ...
            <a class="btn btn-secondary bg-white mx-3" href="/voyantPanel/consultation/consultation/">Reset</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="card">
      ...
      <div id="orderList" class="card-body table-responsive p-0">
        <table class="table text-nowrap">
          ...
          <tbody>
            {foreach from=$consultationsArray item=consultation}
