$(document).ready(function(){
    ...
    let chat=donutChartCanvas.canvas.attributes['data-id3']['value'];
    var donutData = {
      labels: [
          'Question',
          'Téléphone',
      ...
      datasets: [
        {
          data: [quaestion,telphone,webcam, chat],
          backgroundColor : ['#f56954', '#7bb557', '#965991', '#965923'],
        }
      ]
    }
    var donutOptions     = {
    ...
    var form5 = document.getElementById('frmChat');
    $("#displayChat").on('change', function() {
          ...
          $.ajax({
              ...
              success: function(response) {
                ...
                if(response == 1){
                 var htmldialog = $("<div title='" + _t("activated") + "'>" +
      "<p style='text-align:center;font-size:1.6em'><br/>" +
      "<b>" + _t("Chat consultation activated!") + "</b><br>" +
      "</p>" +
      "</div>")
      .dialog({ autoOpen: false, resizable: false, modal: false, draggable :false });
                  ...
                  var htmldialog = $("<div title='" + _t("deactivated") + "'>" +
      "<p style='text-align:center;font-size:1.6em'><br/>" +
      "<b>" + _t("Chat consultation deactivated!") + "</b><br>" +
      "</p>" +
      "</div>")
      .dialog({ autoOpen: false, resizable: false, modal: false, draggable :false });
                }
    ...
    $("#vacances").on('change', function() { console.log('>>>clicked on vacances');
        ...
        if ($(this).is(':checked')) {
            ...
            $('#displayChat').prop('disabled', false);
           switchStatus = $(this).is(':checked');
           display = 1;
        }
        console.log('>>>display vacances', form4.action)
