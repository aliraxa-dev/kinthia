        ...
        <div class="row">
            <div class="col-lg-12">
                <table class="tablemanage table table-sm table-bordered table-responsive-md">
					...
					<tbody>
						 {if $userWebcamConsultations}
					       {foreach from=$userWebcamConsultations item=consltationArr key=mkey}
							<tr class="line{cycle values='1,2'}">
								...
								<td class="td_left">
									<a href="{"/user/comment/popupconsultation/$consltationArr.userconsultationId/W"|url}" class="link_panel_grey_underline dialog" title="{'orderIndex_comment_rating_title'|lang} ">{'orderIndex_comment_rating'|lang}</a>
									<br/>
									<br/>
								</td>
