        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="mb-3">
                  ...
                  <a href="{'/user/order/chat'|url}" class="btn btn-primary">Consultation par chat (0)</a>
                </div>
            </div>
        </div>
        { /if }
                          ...
                          <tr>
                            ...
                            <td>
                              <!--- Direct to voyant -->
                                ...
                                {else}
                                    {if !empty($voyant.paymentExpertPlatform) && $voyant.paymentExpertPlatform == 1 && !empty($orderArr.price)}
                                      {$orderArr.price}
                                    {/if}
                                {/if}
