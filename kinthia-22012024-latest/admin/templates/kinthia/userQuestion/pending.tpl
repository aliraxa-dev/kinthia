...
{/capture}
{include file='includes/header.tpl' page="index" title="Questions en attente - {'Panel expert - Kinthia'|lang}"}
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">{$userQuestionsCount} Questions en attente</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
  ...
  <div class="col-md-12">
    <div class="card">
        ...
        <table class="table text-nowrap">
          ...
          <tbody>
            ...
            <tr class="{cycle values='bg-grey-kin, '}">
              ...
              <td><a href="{"/admin/user/editUser/$userQuestion.user.userId"|url}" >{$userQuestion.user.name}</a></td>
      ...
      <div class="card-footer clearfix">
        ...
        <option value="answered" selected="selected"> Question traitée </option>
        </select>
