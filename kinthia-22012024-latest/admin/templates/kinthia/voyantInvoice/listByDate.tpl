        ...
        <table class="table text-nowrap">
          <thead>
            <tr>
              ...
              <th>See</th>
              <th>Upload</th>
              <th>Uploaded by Platform</th>
              <th>Generate</th>
              <th>Uploaded by Expert</th>
            </tr>
          </thead>
          <tbody>
            {foreach from=$invoicesList item=list}
            <tr class="{cycle values='bg-grey-kin, '}">
              ...
              <td><a href="{'/admin/order/cartDetails'|url}">Upload</a></td>
              <td><a href="{'/admin/order/cartDetails'|url}">Uploaded by Platform</a></td>
              <td><a href="{'/admin/order/cartDetails'|url}">Generate</a></td>
              <td><a href="{'/admin/order/cartDetails'|url}">Uploaded by Expert</a></td>
            </tr>
            {/foreach}
{*            <tr class="{cycle values='bg-grey-kin, '}">*}
{*              <td>$userName</td>*}
