      ...
      <div class="card-footer">
        <div class="row">
          ...
          <!-- /.col -->
           <div class="col border-right">
            <div class="description-block">
              <h5 class="description-header">{$statistic.totaltimeonChat}</h5>
              <span class="description-text">Temps passés au chat</span>
            </div>
            <!-- /.description-block -->
            </div>
          <!-- /.col -->
        ...
        <table class="table text-nowrap">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{$statistic.totaltimeonChat}</td>
              <td>{math equation="($statistic.getTotalEarningAllOnPhone/60)*1" format="%.2f"}€</td>
      ...
      <div class="card-body table-responsive p-0">
        <table class="table text-nowrap">
          ...
          <tbody>
            ...
            <tr>
              <td>Temps passé par chat</td>
              <td>{$statistic.getAllConsultationtimeCurrentmonthOnChat}</td>

                  <td>{math equation="($statistic.totalAllEarningCurrentmonthOnChat/60)*1" format="%.2f"}€</td>
             <td>{math equation="($statistic.totalCompanyEarningCurrentmonthOnChat/60)*1" format="%.2f"}€</td>
            </tr>
            <tr class="bg-kinthia">
              <td><strong>Gain total</strong></td>
              <td></td>
