...
<div class="content">
          ...
          <div class="col-md-12">
            ...
            <form action="{"/admin/voyant/save"|url}" method="post" enctype="multipart/form-data" id="editVoyantFormnew">
              <div class="card-body table-responsive p-0">
                  ...
                  <input type="hidden" class="input_text_medium" name="displayChat" value=" {$voyant.displayChat}" />
                  {else}
    ...
    <tr>
        ...
        <td><input type="radio" name="paymentExpertPlatform" value=1 checked="checked" /> Expert &nbsp;&nbsp;<input type="radio" name="paymentExpertPlatform" value="0" /> Plateform</td>
    </tr>
    ...
    <tr>
        ...
        <td><input type="checkbox" class="checkbox" name="payPalEnableDisable" value="1"> Enable PayPal</td>
    </tr>
    <tr>
