  ...
  <div class="col-md-12">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="row">
          <div class="col-md-4" style="width:30%!important;flex:0 0 27.56%;" >
           ...
           {*  <div class="text-center mt-4">
            ...
            <div class="text-center mt-4" id="stopConsult" style="display:none;"><a id="dispose" class="stop-consultation" href="javascript:void(0);">Stop consultation</a> </div>
          </div>
          <div class="col-md-8">
