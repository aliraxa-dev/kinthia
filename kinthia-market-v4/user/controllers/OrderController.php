...
class User_OrderController extends AppController
{
    ...
    */
    ...
    public function mailAction($page = 1)
    {
        ...
        $c->addWithRelation('orderItems', array('fields' => 'orderId, itemId, packid,quantity, totalPrice,voyantQuestions.title','criteria' => $orderItemsCriteria));
        
        $userQuestionsCriteria = new Criteria();
        $userQuestionsCriteria->add('status', 'pending');
        $c->addWithRelation('userQuestions', array('fields' => 'orderId, status',
