    ...
    $.backgroundTask = function(taskId){
        ...
        var that = {
            ...
            sendControlAction: function(action){
                $.post(setting.siteRootUrl + '/index.php/admin/task/' + action, {
                    taskId: that.taskId
                });
            },
            ...
            startOnClick: function(){
                ...
                $.post(setting.siteRootUrl + '/index.php/admin/task/init', query, that.onStartSuccess);
            },
            ...
            updateStatus: function(){
                $.post(setting.siteRootUrl + '/index.php/admin/task/getStatus', {
                    taskId: that.taskId
