    ...
    public function ajaxpage3Action(){
       ...
       $userFavObj = new Criteria();
        ...
        if(!empty($this->request->sortValues=='bestRated'))
        {
           ...
           $sortObjFromVoyantBest = Model::factoryInstance("voyant")->findAll($sortBestObj,"max(voyants.ratingAverage) as ratingAverage,displayWebcam ,consultationStatus,displayEmail,name,headerDescription,voyantId,urlName,imageSrc, shortDescription ,displayPhone ");
        ...
        if(!empty($this->request->sortValues=='W'))
        {
            ...
            $voyantDetails = Model::factoryInstance("voyant")->findAll($voyantDetailsObj,"displayWebcam ,ratingAverage ,consultationStatus,displayEmail,name,headerDescription,voyantId,urlName,imageSrc, shortDescription ,displayPhone  ");
            $userFav2= [];
            foreach($voyantDetails as $userFav)
            {
                $voyantId = $userFav['voyantId'];
          ...
          if(!empty($this->request->sortValues=='P'))
          {
              ...
              $voyantDetailsPhone = Model::factoryInstance("voyant")->findAll($voyantDetailsPhoneObj,"displayWebcam ,ratingAverage ,consultationStatus,displayEmail,name,headerDescription,voyantId,urlName,imageSrc, shortDescription ,displayPhone  ");
              $userFav2= [];
            ...
            if(!empty($this->request->sortValues=='E'))
            {
                ...
                $voyantDetailsEmail = Model::factoryInstance("voyant")->findAll($voyantDetailsEmailObj,"displayWebcam ,ratingAverage ,consultationStatus,displayEmail,name,headerDescription,voyantId,urlName,imageSrc, shortDescription ,displayPhone  ");
                $userFav2= [];
