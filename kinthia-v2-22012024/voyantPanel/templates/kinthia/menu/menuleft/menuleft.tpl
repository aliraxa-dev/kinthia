    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info color-c2c7d0">
          {$voyant.name}<br>
          <strong class="text-white">Status</strong> - <strong class="text-success">available</strong> / <strong class="text-warning">in consultation</strong> / <strong style="text-danger">on vacation</strong><br>
